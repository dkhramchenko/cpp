...
namespace task4
{
    public abstract class Car
    {
        ...
        public abstract string CarText();
    ...
    public class Lorry : Car
    {
        ...
        public Lorry(int price, int truckLength, string brand = "audi")
        {
            this.Brand = brand;
            this.Price = price;
        ...
        {
            return String.Format("Марка: {0}; Цена: {1}; Длина прицепа: {2};", Brand, Price, truckLength);
        }
    }
}
